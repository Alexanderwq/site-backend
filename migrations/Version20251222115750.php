 ...
 */
final class Version20251222115750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE account_massage_form_metro_stations (massage_form_id UUID NOT NULL, metro_station_id UUID NOT NULL, PRIMARY KEY (massage_form_id, metro_station_id))');
        ...
        $this->addSql('CREATE TABLE account_metro_stations (id UUID NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
